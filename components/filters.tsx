...
export default function Filters({
  ...
  const inputCls =
    "h-9 px-3 text-sm border border-zoca-stroke rounded-lg bg-white focus:outline-none focus:border-zoca-blue focus:ring-2 focus:ring-blue-100 transition-colors text-zoca-text";
