...
export default function Filters({
  ...
  const inputCls =
    "h-9 px-3 text-sm border border-zoca-stroke rounded-lg bg-white focus:outline-none focus:border-zoca-purple focus:ring-1 focus:ring-zoca-purple/20 transition-colors text-zoca-purpleDark";

  return (
    <div className="card-zoca">
      <div className="flex flex-wrap gap-2 items-center">
        <div className="relative flex-1 min-w-[240px]">
          <Search size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-zoca-neutral40" />
          <input
        ...
        <label className="flex items-center gap-1.5 text-xs text-zoca-neutral40 px-2">
          <input
            type="checkbox"
